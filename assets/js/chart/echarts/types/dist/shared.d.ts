...
declare class ZRender {
    ...
    setBackgroundColor(backgroundColor: string | GradientObject | PatternObject): void;
    getBackgroundColor(): string | GradientObject | ImagePatternObject | SVGPatternObject;
...
declare class ECharts extends Eventful<ECEventDefinition> {
     ...
     */
    getVisual(finder: ModelFinder$1, visualType: string): string | number | number[] | ImagePatternObject | SVGPatternObject | LinearGradientObject | RadialGradientObject;
    /**
