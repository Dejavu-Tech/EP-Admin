                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6 main-header">
                            ...
                            <h2>后台权限<span>管理</span></h2>
                        </div>
                        <div class="col-lg-6 breadcrumb-right" style="float: right">
                            <ol class="breadcrumb">
                                <a href="<?php echo U('perm/addrole');?>"><button class="btn btn-info btn-air-info" style=""><i class="fa fa-plus"></i>添加新权限组</button></a>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <form action="" class="form theme-form layui-form m-t-20" lay-filter="example" method="post" >
                                    <div class="dataTables_wrapper no-footer">
                                        <div class="page-table-header m-b-20 row">
                                            ...
                                            <div class="btn-group">
                                                <button class="btn btn-pill btn-primary btn-sm  btn-operation"  type="button" data-toggle='batch' data-href="<?php echo U('perm/rolestatus',array('status'=>1));?>">启用</button>
                                                <button class="btn btn-pill btn-primary btn-sm  btn-operation"  type="button" data-toggle='batch' data-href="<?php echo U('perm/rolestatus',array('status'=>0));?>">禁用</button>
                                                <button class="btn btn-pill btn-primary btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php echo U('perm/roledelete');?>">删除</button>
                                            </div>
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switch" style="margin-bottom: 0">
                                                            <input type="checkbox" name="" lay-filter="statewsitch" data-href="<?php echo U('perm/rolestatus',array('id'=>$row['id']));?>" <?php if( $row['status']==1){ ?>checked<?php  }else{ } ?> lay-skin="switch" lay-text="">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-pill btn-primary btn-sm" href="<?php echo U('perm/addrole', array('id' => $row['id']));?>" >
                                                            编辑
                                                        </a>

                                                        <a class="btn btn-pill btn-primary btn-sm deldom" href="javascript:;" data-href="<?php echo U('perm/roledelete', array('id' => $row['id']));?>" data-confirm='确认要删除吗?'>
                                                            删除
                                                        </a>
                                                    </td>
                                                </tr>
