				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-6 main-header">
							...
							<h2>虚拟会员<span>列表</span></h2>
						</div>
						<div class="col-lg-6 breadcrumb-right" style="float: right">
							<ol class="breadcrumb">
								<a href="<?php echo U('user/adduserjia', array('ok' => 1));?>" class="btn btn-info btn-air-info"><i class="fa fa-plus"></i> 添加虚拟会员</a>
							</ol>
						</div>
					</div>
				</div>
								...
								<form action="" method="get" class="form-horizontal form-search layui-form" role="form">
									...
									<div class="form-row">
										<div class="p-r-5" style="">
											<input type="text" class="form-control" name='keyword' value="<?php echo ($_GPC['keyword']); ?>" placeholder="输入会员名点击搜索">
										</div>
										<div class="p-r-5" style="">
								...
								<form action="" class="form theme-form layui-form m-t-20" lay-filter="example" method="post" >
									<div class="dataTables_wrapper no-footer">
										<div class="page-table-header m-b-20 row">
											...
											<div class="btn-group">
												<button class="btn btn-pill btn-primary btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php echo U('user/deleteuserjia');?>">
													删除
												</button>
											</div>
										</div>
										<div class="table-responsive">
											<table class="display dataTable text-center" lay-even lay-skin="line" lay-size="lg">
												...
												<tr>
													...
													<td>
														<a href="<?php echo U('user/adduserjia', array('id' => $row['id'] , 'ok' => 1));?>" class="btn btn-pill btn-primary">编辑</a>
														<a href="javascript:;" data-href="<?php echo U('user/deleteuserjia', array('id' => $row['id']));?>" data-confirm='确认要删除此虚拟会员吗?' class="btn btn-pill btn-primary deldom">删除</a>
													</td>
												</tr>
												<?php } ?>
												</tbody>
