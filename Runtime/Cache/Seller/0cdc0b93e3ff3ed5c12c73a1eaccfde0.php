				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-6 main-header">
							<h6 class="mb-0">当前位置</h6><h2>商品规格<span>管理</span></h2>
						</div>
						<div class="col-lg-6 breadcrumb-right" style="float: right">
							<ol class="breadcrumb">
								<a href="<?php echo U('goods/addspec', array('ok' => 1));?>"><button class="btn btn-info btn-air-info" style=""><i class="fa fa-plus"></i>添加商品规格</button></a>
							</ol>
						</div>
					</div>
				</div>
								...
								<form action="" class="form theme-form layui-form m-t-20" lay-filter="example" method="post" >
									<div class="dataTables_wrapper no-footer">
										<div class="page-table-header m-b-20 row">
											...
											<div class="btn-group">
												<button class="btn btn-pill btn-primary btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除吗?" data-href="<?php echo U('goods/deletespec');?>">
													删除
												</button>
											</div>
										</div>
											...
											<table class="display dataTable text-center" lay-even lay-skin="line" lay-size="lg">
												...
												<tr>
													...
													<td class="text-center">
														<a   class="btn btn-pill btn-primary btn-sm" href="<?php echo U('goods/editspec', array('id' => $row['id'], 'ok' => 1));?>"  >
															编辑
														</a>
														<?php if($row['id']!='default'){ ?>
														<a  class="btn btn-pill btn-primary btn-sm deldom" href="javascript:;" data-href="<?php echo U('goods/deletespec', array('id' => $row['id']));?>" data-confirm='确认要删除吗?'>
															删除
														</a>
														<?php } ?>
													</td>
