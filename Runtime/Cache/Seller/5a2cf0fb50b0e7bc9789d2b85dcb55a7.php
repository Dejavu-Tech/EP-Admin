				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-6 main-header">
							<h6 class="mb-0">当前位置</h6><h2>工商<span>资质</span></h2>
						</div>
					</div>
				</div>
			</div>
							...
							<form action="" method="post" class="form theme-form layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
								<div class="card-body">
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">工商资质显示</label>
										<div class="col-sm-10">
											<div class="form-group m-checkbox-inline custom-radio-ml m-t-10 m-l-5 mb-0">
												<div class="radio radio-primary">
													<input id="radioinline1" type="radio" name="parameter[goods_industrial_switch]" value="0" <?php if(empty($data) || $data['goods_industrial_switch'] ==0 ){ ?>checked <?php } ?> />
													<label class="mb-0" for="radioinline1">关闭</label>
												</div>
												<div class="radio radio-primary">
													<input id="radioinline2" type="radio" name="parameter[goods_industrial_switch]" value="1" <?php if(!empty($data) && $data['goods_industrial_switch'] ==1 ){ ?>checked <?php } ?> />
													<label class="mb-0" for="radioinline2">开启</label>
												</div>
											</div>
											<small>商品详情页显示工商资质信息</small>
										</div>
									</div>
									<div class="form-group row" >
										<label class="col-sm-2 col-form-label">工商资质图片</label>
										<div class="col-sm-10">
