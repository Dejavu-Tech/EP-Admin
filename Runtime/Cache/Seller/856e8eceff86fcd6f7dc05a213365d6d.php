							...
							<div class="card-body">
								<form action="" method="get" class="form-horizontal form-search layui-form" role="form">
									...
									<div class="form-row m-b-20">
										...
										<div class="p-r-5">
											<input type="text" class="form-control"  name="keyword" value="<?php echo ($_GPC['keyword']); ?>" placeholder="申请订单id"/>

										</div>
										<div class="p-r-5">
											<button class="btn btn-primary" type="submit"> 搜索</button>
											<button type="submit" name="export" value="1" class="btn btn-success  btn btn-primary">导出</button>
										</div>
								...
								<form action="" class="form theme-form layui-form" lay-filter="example" method="post" >
									<div class="dataTables_wrapper no-footer">
										<div class="page-table-header m-b-20 row">
											...
											<div class="btn-group">
												<button class='btn btn-pill btn-primary btn-sm btn-op btn-operation'  type="button" data-toggle='batch' data-href="<?php echo U('communityhead/agent_check_apply',array('state'=>1));?>"  data-confirm='确认要审核通过，已打款?'>
													审核通过
												</button>
												<button class='btn btn-pill btn-primary btn-sm btn-op btn-operation' type="button"  data-toggle='batch' data-href="<?php echo U('communityhead/agent_check_apply',array('state'=>2));?>" data-confirm='确认要拒绝通过?'>
													拒绝通过
												</button>
											</div>
										</div>
											...
											<table class="display dataTable text-center" lay-even lay-skin="line" lay-size="lg">
												...
												<tr>
													...
													<td style="overflow:visible;text-align: center;">
															<a class="btn btn-pill btn-primary" href="<?php echo U('order/order',array('headid' => $row['head_id']));;?>" >
																推广订单
															</a>
															<a class="btn btn-pill btn-primary" href="<?php echo U('communityhead/goodslist',array('head_id' => $row['head_id']));;?>">
																查看在售商品
															</a>
													</td>
												</tr>
