							...
							<form action="" method="post" class="form theme-form layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
								<div class="card-body">
									<div class="form-group row" >
										<label class="col-sm-2 col-form-label">手机号授权</label>
										<div class="col-sm-10">
											<div class="form-group m-t-5 m-checkbox-inline mb-0 custom-radio-ml">
												<div class="radio radio-primary">
													<input type="radio"  name="data[is_show_auth_mobile]" <?php if( !isset($data['is_show_auth_mobile']) || $data['is_show_auth_mobile'] ==0 ){ ?> checked <?php } ?> value="0" title="否" />
												</div>
												<div class="radio radio-primary">
													<input type="radio"  name="data[is_show_auth_mobile]" <?php if( isset($data['is_show_auth_mobile']) && $data['is_show_auth_mobile'] ==1 ){ ?> checked <?php } ?> value="1" title="是" />
												</div>
											</div>
										</div>
									</div>
									<div class="form-group row" >
										<label class="col-sm-2 col-form-label">显示会员等级</label>
										<div class="col-sm-10">
											<div class="form-group m-t-5 m-checkbox-inline mb-0 custom-radio-ml">
												<div class="radio radio-primary">
													<input type="radio"  name="data[is_show_member_level]"  <?php if( !isset($data['is_show_member_level']) || $data['is_show_member_level'] ==0 ){ ?> checked <?php } ?> value="0" title="隐藏" />
												</div>
												<div class="radio radio-primary">
													<input type="radio"  name="data[is_show_member_level]" <?php if( isset($data['is_show_member_level']) && $data['is_show_member_level'] ==1 ){ ?> checked <?php } ?> value="1" title="显示" />
												</div>
											</div>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">会员是否需要审核</label>
										<div class="col-sm-10">
											<div class="form-group m-t-5 m-checkbox-inline mb-0 custom-radio-ml">
												<div class="radio radio-primary">
									...
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">未登录未审核不显示价格</label>
										<div class="col-sm-10">
											<div class="form-group m-t-5 m-checkbox-inline mb-0 custom-radio-ml">
												<div class="radio radio-primary">
									...
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">是否收集表单信息</label>
										<div class="col-sm-10">
											<div class="form-group m-t-5 m-checkbox-inline mb-0 custom-radio-ml">
												<div class="radio radio-primary">
									...
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">普通等级可以下单</label>
										<div class="col-sm-10">
											<div class="form-group m-t-5 m-checkbox-inline mb-0 custom-radio-ml">
												<div class="radio radio-primary">
