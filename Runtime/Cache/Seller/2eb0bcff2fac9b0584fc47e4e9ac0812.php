							...
							<form action="" method="post" class="form theme-form layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
								<div class="card-body">
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">评价审核：</label>
										<div class="col-sm-10">
											<div class="form-group m-checkbox-inline custom-radio-ml m-t-10 m-l-5 mb-0">
												<div class="radio radio-primary">
													<input type='radio' name='data[open_comment_shenhe]' value='1' <?php if(!empty($data) && $data['open_comment_shenhe']=='1'){ ?>checked<?php } ?> title="开启" />
												</div>
												<div class="radio radio-primary">
													<input type='radio' name='data[open_comment_shenhe]' value='0' <?php if(empty($data['open_comment_shenhe']) || $data['open_comment_shenhe'] ==0 ){ ?>checked<?php } ?> title="关闭"  />
												</div>
												<br>
												<small>审核：审核通过才显示。不审核，评价完成直接显示</small>
											</div>
										</div>
									</div>
								</div>
