				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-6 main-header">
							...
							<h2>会员等级<span>列表</span></h2>
						</div>
						<div class="col-lg-6 breadcrumb-right" style="float: right">
							<ol class="breadcrumb">
								<a href="javascript:;" data-href="<?php echo U('user/adduserlevel',array('ok' => 1));?>" class="btn btn-info btn-air-info ajaxModal"><i class="fa fa-plus"></i> 添加会员等级</a>
							</ol>
						</div>
					</div>
				</div>
								...
								<form action="" class="form theme-form layui-form m-t-20" lay-filter="example" method="post" >
									<div class="dataTables_wrapper no-footer">
										<div class="page-table-header m-b-20 row">
											...
											<div class="btn-group">
												<button class="btn btn-pill btn-primary btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php echo U('user/deleteuserlevel');?>">
													删除
												</button>
											</div>
										</div>
										<div class="table-responsive">
											<table class="display dataTable text-center" lay-even lay-skin="line" lay-size="lg">
												...
												<tr>
													...
													<td >
														<?php
 if($row['id'] == 'default'){ echo '无'; }else if($row['is_auto_grade'] == 1){ echo '自动'; }else{ echo '手动'; } ?>
													</td>
													<td >
														<?php
 if($row['is_auto_grade'] == 1){ echo "会员消费金额满".floatval($row['level_money'])."元"; }else{ echo '无'; } ?>
													</td>
													<td ><?php echo ($row['membercount']); ?></td>
													<td>
														<a class="btn btn-pill btn-primary" href="<?php echo U('user/index', array('level_id' => $row['id']));?>"><span data-toggle="tooltip" data-placement="top" data-original-title="等级会员">等级会员</span></a>
														<?php if($row['id']!='default'){ ?>
														<a href="javascript:;" data-href="<?php echo U('user/adduserlevel', array('id' => $row['id'] , 'ok' => 1));?>" class="btn btn-pill btn-primary ajaxModal">编辑</a>
														<a href="javascript:;" data-href="<?php echo U('user/deleteuserlevel', array('id' => $row['id']));?>" class="btn btn-pill btn-primary deldom" data-confirm='确认要删除?<br /><br /><p style="color:red;">该等级涉及的所有会员都会变成默认等级？</p>'>删除</a>
														<?php } ?>
													</td>
												</tr>
												<?php } ?>
