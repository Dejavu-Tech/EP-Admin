				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-6 main-header">
							...
							<h2>团长分组<span>列表</span></h2>
						</div>
						<div class="col-lg-6 breadcrumb-right" style="float: right">
							<ol class="breadcrumb">
								<a href="javascript:;" data-href="<?php echo U('communityhead/addusergroup');?>" class="btn btn-info btn-air-info ajaxModal"><i class="fa fa-plus"></i> 添加团长分组</a>
							</ol>
						</div>
					</div>
				</div>
								...
								<form action="" method="get" class="form-horizontal form-search layui-form" role="form">
									...
									<div class="form-row">
										<div class="p-r-5" style="">
											<input type="text" class="form-control" name='keyword' value="<?php echo ($gpc['keyword']); ?>" placeholder="输入关键词点击搜索">
										</div>
										<div class="p-r-5" style="">
								...
								<form action="" class="form theme-form layui-form m-t-20" lay-filter="example" method="post" >
									<div class="dataTables_wrapper no-footer">
										<div class="page-table-header m-b-20 row">
											...
											<div class="btn-group">
												<button class="btn btn-pill btn-primary btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="{php echo shopUrl('user/deleteusergroup')}">
													删除
												</button>
											</div>
										</div>
										<div class="table-responsive">
											<table class="display dataTable text-center" lay-even lay-skin="line" lay-size="lg">
												...
												<td style="cursor: pointer;" onclick='location="<?php echo U("communityhead/index", array('group_id' => $row['id']));?>"'><?php echo ($row['groupname']); ?></td>
												<td style="cursor: pointer;" onclick='location="<?php echo U("communityhead/index", array('group_id' => $row['id']));?>"'><?php echo ($row['membercount']); ?></td>

												<td>

													<a class='btn btn-pill btn-primary btn-xs ' href="<?php echo U('communityhead/index', array('group_id' => $row['id']));?>">
										<span data-toggle="tooltip" data-placement="top" data-original-title="分组团长">
												<i class='icow icow-member'></i>分组团长
													...
													<a class="btn btn-pill btn-primary btn-xs ajaxModal" href="javascript:;" data-href="<?php echo U('communityhead/addusergroup', array('id' => $row['id']));?>">
														编辑
													</a>

													<a  class='btn btn-pill btn-primary btn-xs deldom' href="javascript:;" data-href="<?php echo U('communityhead/deleteusergroup', array('id' => $row['id']));?>" data-confirm='确认要删除此分组吗'>
														删除
													</a>
